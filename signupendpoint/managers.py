...
class UserManager(BaseUserManager):
    ...
    # making user obj so it is accessible to methods- Per Enny. I have to specify the user that I am calling in this class
    user = " "
    ...
    def create_user(self, first_name, last_name, email, phone_number, password = None,**extra_fields):
        ...
        # This isn't working because it is referring to a user object that does not exist in this scope and the user variable is not defined. need to make a class variable so that all methods in this class have access to it. -Enny
